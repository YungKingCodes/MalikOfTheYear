      ...
      <div className="container flex flex-col gap-8 py-8 md:py-12">
        <div className="flex flex-col gap-10 lg:flex-row lg:gap-20">
          <div className="flex flex-col gap-2 lg:w-1/3">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold">Malik of The Year</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              Your sports competition management platform to crown your GOAT.
            </p>
          </div>
          <div className="grid flex-1 grid-cols-2 gap-10 sm:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/teams" className="text-muted-foreground transition-colors hover:text-foreground">
                    Teams
                  </Link>
                </li>
                <li>
                  <Link href="/players" className="text-muted-foreground transition-colors hover:text-foreground">
                    Players
                  </Link>
                </li>
                <li>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Malik of The Year. All rights reserved.
          </p>
